...
def jitter_pointcloud(pointcloud, sigma=0.1, clip=0.5):
...
class ModelNet40(Dataset):
    def __init__(self, num_points, partition='train', num_subsampled_points=768, gaussian_noise=False, unseen=False, factor=4,split='train', rot_factor=4):
...
#                 self.label = self.label[self.label<19]
    ...
    def __getitem__(self, item):
        ...
        #### Uniform sampling - no condition imposed for identity
