...
# +
# import sys
# sys.path.append('/workspace/program/learning3d')
...
# # # !ls /workspace/program/learning3d/utils/

# # from utils.lib import pointnet2_utils
# # import pointnet2
# import sys
# egg_path='/usr/local/lib/python3.6/dist-packages/pointnet2-0.0.0-py3.6-linux-x86_64.egg'
...
import sys
sys.path.append('/workspace/program')
# # !ls /workspace/program

try:
    from learning3d.utils.lib import pointnet2_utils as pointutils
